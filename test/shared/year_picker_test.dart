...
void main() {
  group('YearsPicker', () {
    ...
    testWidgets('should apply yearsPickerTheme padding around PageView',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should call onLeadingDateTap when the year range header is tapped',
        (WidgetTester tester) async {
      bool tapped = false;
    ...
    testWidgets('should pre-select a year when selectedDate is provided',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should update highlighted year when selectedDate changes via didUpdateWidget',
        (WidgetTester tester) async {
              ...
              builder: (context, setState) {
                return Column(
                  children: [
                    ElevatedButton(
                      onPressed: () =>
                          setState(() => selectedDate = DateTime(2015, 1, 1)),
      ...
      expect(
        find.byWidgetPredicate((w) =>
            ...
            (w.decoration as BoxDecoration).color == Colors.indigo),
        findsNothing,
      );
