[![Tests](https://github.com/hasanmhallak/date_picker/actions/workflows/tests.yml/badge.svg)](https://github.com/hasanmhallak/date_picker/actions/workflows/tests.yml)
