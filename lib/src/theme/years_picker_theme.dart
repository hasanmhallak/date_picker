...
class YearsPickerTheme extends ThemeExtension<YearsPickerTheme>
  ...
  /// The text style of year cells which are selectable.
  ///
  /// Defaults to [TextTheme.titleLarge] with a [FontWeight.normal]
  /// and [ColorScheme.onSurface] color.
  final TextStyle? enabledCellsTextStyle;

  /// The cell decoration of year cells which are selectable.
  ///
  /// Defaults to empty [BoxDecoration].
  final Decoration? enabledCellsDecoration;

  /// The text style of year cells which are not selectable.
  ///
  /// Defaults to [TextTheme.titleLarge] with a [FontWeight.normal]
  /// and [ColorScheme.onSurface] color with 30% opacity.
  final TextStyle? disabledCellsTextStyle;

  /// The cell decoration of year cells which are not selectable.
  ///
  /// Defaults to empty [BoxDecoration].
  ...
  /// The text style of selected year cell.
  ///
  /// Defaults to [TextTheme.titleLarge] with a [FontWeight.normal]
  /// and [ColorScheme.onPrimary] color.
  final TextStyle? selectedCellTextStyle;

  /// The cell decoration of selected year cell.
  ///
  ...
  /// Padding around each year cell's content (inside the grid tile, around the
  /// decorated [Container]).
  ///
  /// Defaults to `EdgeInsets.symmetric(horizontal: 8, vertical: 16)`.
  final EdgeInsetsGeometry? cellsPadding;

  /// Padding around the years grid (the [PageView] below the header).
  ///
  ...
  /// Returns a [YearsPickerTheme] populated with default values.
  static YearsPickerTheme defaults(BuildContext context) {
