...
@immutable
class MonthsPickerTheme extends ThemeExtension<MonthsPickerTheme> with DiagnosticableTreeMixin {
  ...
  @override
  MonthsPickerTheme lerp(covariant ThemeExtension<MonthsPickerTheme>? other, double t) {
